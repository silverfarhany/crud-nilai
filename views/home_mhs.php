...
<body id="page-top">
  ...
  <nav id="sidebar-wrapper">
    <ul class="sidebar-nav">
      <li class="sidebar-brand">
        <a class="js-scroll-trigger" href="#page-top">Mahasiswa
        </a>
  ...
  <header class="masthead d-flex">
    <div class="container text-center my-auto">
      ...
      <h3 class="mb-5">
        <em> Mahasiswa bisa Lihat, Komplain, dan Perbaiki nilai mu, disini!</em>
      </h3>
      <a class="btn btn-primary btn-xl js-scroll-trigger" href="lihat_nilai.php">Lihat Nilai</a>
    </div>
